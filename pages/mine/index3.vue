    ...
    <view v-if="currentPage === 'profile'">
      ...
      <view class="menu-container">
        ...
        <view class="menu-list">
          ...
          <view class="menu-item" @tap="handleMenuClick('个人主页')">
            <view class="menu-item-left">
              <view class="menu-icon blue">
                <text class="iconfont icon-user"></text>
              </view>
              <view class="menu-text">
                <text class="menu-name">个人主页</text>
                <text class="menu-desc">查看和管理个人主页</text>
              </view>
            </view>
            <text class="iconfont icon-chevron-right"></text>
          </view>
...
.icon-folder:before { content: "\e60f"; } /* 新增：案例管理图标 */
</style>