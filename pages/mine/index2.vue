		...
		<view v-if="currentPage === 'profile'">
				...
				<view class="profile-header" @tap="goToPersonalCenter">
					...
					<view class="user-info">
						...
						<view class="current-role">
							<text class="iconfont icon-user"></text> {{ userInfo.role || '商家' }}
						</view>
					</view>
				</view>
			</view>
			...
			<view class="menu-container">
				...
				<view class="menu-list">
					...
					<view class="menu-item" @tap="handleMenuClick('店铺设置')">
						<view class="menu-item-left">
							...
							<view class="menu-text">
								...
								<text class="menu-desc">配置店铺信息和参数</text>
							</view>
						</view>
						<text class="iconfont icon-chevron-right"></text>
					</view>
		...
		<view v-if="showRolePanel" class="role-selector">
			<view class="role-panel">
				...
				>
					...
					<view class="role-info">
						<text class="role-name">监工</text>
						<text class="role-desc">监理装修过程</text>
					</view>
				</view>
...
<style>
	...
	.icon-cube:before { content: "\e60f"; } /* 新增：产品管理图标 */
</style>